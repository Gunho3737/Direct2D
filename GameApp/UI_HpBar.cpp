...
void UI_HpBar::Start()
{
	...
	HPBarRenderer->GetTransform()->SetLocalScaling({ 250.0f*0.7f, 150.0f*0.7f, 1.0f } );
	...
	float4 HPIconScale = { { 57.0f*0.70f, 70.0f*0.70f, 1.0f } }; 
	float4 HPIconSpace = { 75.0f*0.70f, 0.0f, 0.0f, 0.0f };
